 ...
 * @LastEditors: 张泽雨
 * @LastEditTime: 2022-04-28 22:51:31
...
<template>
    ...
    <div>
        <a-button @click="swichBtn(item)" type="primary" style="margin-left:10px" :key="item.name" v-for="item in tabs">我是组件{{ item.name }}</a-button>
    </div>
...
import { ref, reactive, onBeforeMount, onMounted, onBeforeUpdate, onUpdated, onBeforeUnmount, onUnmounted ,markRaw , defineAsyncComponent} from 'vue';
